...
class TestGenerateMembres(unittest.TestCase):
    ...
    def test_get_file_path(self):
        ...
        self.assertEqual(get_file_path("test.csv"), "./../data/csv/test.csv")
    ...
    def test_charger_membres_empty_file(self):
        ...
        self.assertEqual(charger_membres('./../data/csv/empty.csv'), [])
    ...
    def test_charger_membres_valid_file(self):
        ...
        self.assertEqual(charger_membres('./../data/csv/valid.csv'), expected)
